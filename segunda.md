...
* [Ejercicio de Pablo, en C++] (https://github.com/pablopaolus/repositorio_pablopaolus/blob/master/seleccion.cpp), [Documentación] (https://github.com/pablopaolus/repositorio_pablopaolus/blob/master/docu_seleccion.md)
